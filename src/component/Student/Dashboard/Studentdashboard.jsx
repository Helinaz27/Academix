  ...
  return (
    <div className="bg-gray-200 pt-10 px-1 md:px-5 ">
      <div className="flex items-right mb-2 ">
        <input
          className="rounded-lg h-[40px] w-[15%] font-serif text-x p-3 ml-auto "
          type="text"
          placeholder="Search ..."
        />
      </div>
      <div className="flex">
        <div className="flex-1 m-5 md-5 ">
          <div className="bg-white p-5 md:p-10 rounded-[20px] shadow-md mb-4 w-auto h-[200px] relative">
            ...
            <p className="text-gray-600 text-[13px] md:text-[20px]">Welcome to your Dashboard</p>
            <img src="./images/WavingMan.png" alt="wavingMan" className="w-[200px] h-[280px] absolute bottom-0 right-[-40px] md:right-5"/>
          </div>
          ...
          >
            <div className="grid grid-cols-2 gap-2 md:gap-20 justify-center items-center">
              <div className="flex flex-col md:flex-row items-center gap-2 md:gap-10">
                <p className="text-sm lg:text-lg font-bold">{course.code}</p>
